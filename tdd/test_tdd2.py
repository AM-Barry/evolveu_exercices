...
class TestTdd2(unittest.TestCase):
	...
	def test_date_diff(self):
		self.assertEqual(6, tdd2.date_diff("2018-09-08", "2018-09-02"))

	def test_mayan_days(self):
		self.assertEqual(2080, tdd2.mayan_days("2018-09-01", "2012-12-21"))
	...
	def test_lookup(self):
		...
		self.assertEqual('two mine', tdd2.lookup({2:'one', 2:'two', 3:'three'} , 2))
		self.assertEqual('three mine', tdd2.lookup({3:'one', 2:'two', 3:'three'} , 3))